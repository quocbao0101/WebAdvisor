...
<?php
    ...
    {      
        ...
        if($key != NULL)
        {
            $lenhphantrang = "SELECT * from khachsan,vung where khachsan.IDVUNG = vung.IDVUNG AND pheduyet='0' AND TenKhachSan LIKE '%$key%' LIMIT {$vitribatdau},{$sodongtrentrang}";
            $ketquaphantrang = mysqli_query($conn,$lenhphantrang) or die("lỗi");
        }
        else
        {
            $lenhphantrang = "SELECT * from khachsan,vung where khachsan.IDVUNG = vung.IDVUNG AND pheduyet='0' LIMIT {$vitribatdau},{$sodongtrentrang}";
            $ketquaphantrang = mysqli_query($conn,$lenhphantrang) or die("lỗi");
        }
    }
    else
      ...
      <div class="card-header py-3">
        ...
        <div class="card-body" >
            ...
            <table class="table table-bordered" id="dataTable" cellspacing="0">
                ...
                <th class="font-weight-bold text-primary text-center" style="width : 150px"> Tên khách sạn </th>
                ...
                <?php
                 while ($row = mysqli_fetch_array($ketquaphantrang)){
                    ...
                    <?php } ?>
                        ...
                        ?></td>
                        <td>
                            <a class="btn btn-info" href="edit.php?ID=<?php echo $row['IDKhachSan']; ?>">Xem chi tiết</i></a>
                        </td>
                        <td >
