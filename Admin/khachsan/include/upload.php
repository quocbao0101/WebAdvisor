<?php
	...
	if(isset($_POST['btnadd']))
	{
		...
		$sql = "INSERT INTO khachsan(TenKhachSan,MoTa,DiaChi,TongDanhGia,IDVung,dangmocua,pheduyet) VALUES('".$name."','".$mota."','".$diachi."','".$tongdanhgia."','".$vung."','".$open."',1)";
		$result = mysqli_query($conn,$sql) or die("Lỗi");

		// GET id diadiem 
		$sql1 = "SELECT * FROM khachsan WHERE TenKhachSan = '".$name."' AND IDVung = '".$vung."'";
